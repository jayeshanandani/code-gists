...
namespace App\Traits\Sorting\Traits;

use Illuminate\Database\Eloquent\Builder;
use App\Traits\Sorting\Relations\HasOneJoin;
use App\Traits\Sorting\Relations\BelongsToJoin;
use App\Traits\Sorting\Exceptions\EloquentJoinException;
...
trait EloquentJoinTrait
{
    ...
    public function scopeSetOrWhereForJoin(Builder $builder, $column, $operator, $value)
    {
    ...
    public function scopeOrWhereJoin(Builder $builder, $column, $operator, $value)
    {
        list($column, $operator, $value) = QueryNormalizer::normalizeScope(func_get_args());
        $column = $this->performJoin($builder, $column);
